...
#define RMU_SHUTDOWN_FLAG           (1U << 1)
#define GNSS_STARTUP_FLAG           (1U << 2)
#define IRIDIUM_STARTUP_FLAG        (1U << 3)
#define SD_CARD_INIT_FLAG           (1U << 4)
#define SD_CARD_STARTUP_FLAG        (1U << 5)
#define DATA_ACQ_STARTUP_FLAG       (1U << 6)
#define LO_VALID_EDGE_FLAG          (1U << 7)
#define LO_INVALID_EDGE_FLAG        (1U << 8)
#define SODS_VALID_EDGE_FLAG        (1U << 9)
#define SODS_INVALID_EDGE_FLAG      (1U << 10)
#define SOE_VALID_EDGE_FLAG         (1U << 11)
#define SOE_INVALID_EDGE_FLAG       (1U << 12)
#define EJECTION_VALID_EDGE_FLAG    (1U << 13)
#define EJECTION_INVALID_EDGE_FLAG  (1U << 14)
#define RMU_CAMERA_TRIGGER_FLAG     (1U << 15)
#define ANTENNA_DEPLOYED_FLAG       (1U << 16) 
#define IRIDIUM_TX_FLAG             (1u << 17)
#define SYSTEM_MODE_SELECTED_FLAG   (1u << 18)
...
#define RXSM_LO_Pin GPIO_PIN_1
#define RXSM_LO_GPIO_Port GPIOB
#define RXSM_LO_EXTI_IRQn EXTI1_IRQn
#define RXSM_SODS_Pin GPIO_PIN_2
#define RXSM_SODS_GPIO_Port GPIOB
#define RXSM_SODS_EXTI_IRQn EXTI2_IRQn
